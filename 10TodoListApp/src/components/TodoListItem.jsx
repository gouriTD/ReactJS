    ...
    return (
        <div className={`w-full mt-6  p-4 text-2xl focus:outline-none rounded-lg ${isEditable? 'bg-green-100':'bg-blue-200 '} flex`}>
            ...
            <div className='flex w-[90%]'>
                <input type="checkbox" checked={ischecked} onChange={(e)=>setIschecked(e.target.checked)} disabled={isEditable}/>
            ...
            <div className='w-[10%] flex justify-between'>
                ...
                <ListBtn label="delete" className=" bg-red-800" onClick={()=>removeTodo(id)} isDisabled={isEditable}/>
            </div>
        </div>
    )
}
